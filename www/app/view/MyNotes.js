...
Ext.define('SensorDevice.view.MyNotes', {
    ...
    config: {
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {
                                itemId: 'backupNotesButton',
                                iconCls: 'arrow_down',
                                align: 'right'
                            },
                            {
                                itemId: 'restoreNotesButton',
                                iconCls: 'arrow_up',
                                align: 'right',
                                margin: '0 20 0 0'
                            },
                            {
                                itemId: 'trashNotesButton',
                                iconCls: 'trash',
                                align: 'right',
                                margin: '0 20 0 0'
                            },
        ...
        listeners: [
            ...
            {
                delegate: '#backupNotesButton',
                event: 'tap',
                fn: 'onBackupNotesButton'
            },
            {
                delegate: '#restoreNotesButton',
                event: 'tap',
                fn: 'onRestoreNotesButton'
            },
            {
                delegate: '#trashNotesButton',
                event: 'tap',
                fn: 'onTrashNotesButton'
            }
        ]
    },
     ...
     * rilancia l'evento che verrà catturato dal controller.
     */
    onSaveDeviceButtonTap: function(scope, e, eOpts) {
    ...
    /**
     * Metodo che cattura l'evento tap del pulsante che effettua un backup delle note
     * nella memoria di massa del dispositivo; rilancia l'evento che verrà catturato dal controller.
     */
    onBackupNotesButton: function(scope, e, eOpts) {
        console.log('onBackupNotesButton');
        /**
         * @event
         * Lanciato alla pressione del pulsante che effettua un backup delle note.
         * @param {Ext.Component} this
         */
        this.fireEvent('backupNotesCommand', this);
    },
    
    /**
     * Metodo che cattura l'evento tap del pulsante che ripristina i dati delle note dal backup effettuato;
     * rilancia l'evento che verrà catturato dal controller.
     */
    onRestoreNotesButton: function(scope, e, eOpts) {
        console.log('onRestoreNotesButton');
        /**
         * @event
         * Lanciato alla pressione del pulsante che effettua il restore delle note.
         * @param {Ext.Component} this
         */
        this.fireEvent('restoreNotesCommand', this);
    },
    
    /**
     * Metodo che cattura l'evento tap del pulsante che elimina le note presenti nello store relativo;
     * rilancia l'evento che verrà catturato dal controller.
     */
    onTrashNotesButton: function(scope, e, eOpts) {
        console.log('onTrashNotesButton');
        /**
         * @event
         * Lanciato alla pressione del pulsante che elimina le note presenti nello store relativo.
         */
        this.fireEvent('trashNotesCommand');
    }
});